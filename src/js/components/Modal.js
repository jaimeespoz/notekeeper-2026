...
${text}</textarea
   ...
   /**
    * Opens the note modal by appending is to the document body and setting focus on the title field
    */
   const open = function () {
...
/**
 * Create and manages a modal for confirming the deletion of an item
 *
...
const DeleteConfirmModal = function (title) {
   ...
   /**
    * Closes the delete confirmation modal by removing it frm the document body
    */
   const close = function () {
      document.body.removeChild($modal);
      document.body.removeChild($overlay);
