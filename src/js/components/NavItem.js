...
/**
 * Creates a navigation item representing a notebook.
 * This item display the notebook's name, allows editing and deletion of the notebook,
 * and handles click events to display its associated notes
 *
 * @param {string} id       -   The unique identifier of the notebook
 * @param {string} name     -   The name or the notebook
 * @returns {HTMLElement}   -   An HTML element representing tha navigation item for the notebook
 */
export const NavItem = function (id, name) {
   ...
   const /**{Array<HTMLElements>} */ $tooltipElems =
         $navItem.querySelectorAll("[data-tooltip]");
   $tooltipElems.forEach(($elem) => Tooltip($elem));

   /**
    * Handles the click event on the navigation item
    * Updates the note panel's title, retireves the associated notes and marks the item as active
    */
